                       ...
                       <?php
							...
							if (mysql_num_rows($rs)>0) { 
								...
								for ($i=0; $i<$total; $i++)      {
									...
									echo  '<img src="images/1.jpg" alt="Img"> <span><form action="addandbrowse.php" method="POST"><input type=submit name="browsemyshop" value="進入商店" class="btn-cart"><input type=hidden name="shopno" value="'.$row['商店代號'].'"></form></span>';
									echo  '</li>';                                                                                                                                                                                                                                      
								}
							}
				...
				<div class="footer">
                    ...
                    <?php
					   for ($i=4;$i>=1;$i--) {
						...
						echo '<img src="images/picture'.$i.'.jpg" alt="Img"> <span>$8.50</span> Hukbalahap Boots</a>';
						echo '</li>';
					   }
					?>
					</ul>
