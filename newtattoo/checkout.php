...
<?php
						...
						if (isset($_POST['addCartOK'])){
							...
							//****提示**** 這個商品的代號 在 $_POST['buyproductno'] 裡
								$SQLStr = "SELECT  * from 圖案暫存區 where 帳號='".$_SESSION['ADMINUSER']."' and 商品代號='".$_POST['buyproductno']."'";
						...
						// 不買了～　刪除 購物車中 這樣商品
								...
								//****提示**** 這個會員的帳號 在 $_SESSION['ADMINUSER'] 裡								
								//****提示**** 這個商品的代號 在 $_POST['buyproductno'] 裡	
								$SQLStr = "DELETE from 圖案暫存區 where 帳號='".$_SESSION['ADMINUSER']."' and 商品代號='".$_POST['buyproductno']."'";
								echo '<br>SQLStr ='.$SQLStr.'<br>';
								$rs = db_query( $SQLStr);   
					...
					<table>
						...
						<input type=submit name="confirmOrder" value="下一步" class="proceed-btn">
					</form>
							<?php							
								}
								else {
