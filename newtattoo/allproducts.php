                       ...
                       <?php
							...
							if (mysql_num_rows($rs)>0) { 
								...
								for ($i=0; $i<$total; $i++)      {
									...
									echo  '<img src="images/'.$row["商品代號"] .'.jpg " alt="Img"> <span class="icon"></span></a> '.$row["商品名稱"].''.' <em>$'.$row["單價"].'</em><form action="checkout.php" method="POST"><input type=submit name="addCartOK" value="加到圖案暫存區" class="btn-cart"><input type=hidden name="buyproductno" value="'.$row['商品代號'].'"><input type=hidden name="buyqty" value="1"></form><a href="checkout.php" class="btn-wish">關注商品</a>';
									echo "</li>";
								}
							}
						?>                        
