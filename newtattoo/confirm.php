					...
					<table>
							<?php
								...
								if (empty($_POST["confirmOK"])) {
									...
									$SQLStr = "SELECT 圖案暫存區.商品代號,圖案暫存區.單價,商品.商品名稱,商品照片.圖檔名 from 圖案暫存區 inner join 商品 on 圖案暫存區.商品代號 = 商品.商品代號  left outer join 商品照片 on 商品.商品代號=商品照片.商品代號  where 帳號='".$_SESSION['ADMINUSER']."'";
								}
								...
								//*** 現在要開始 產生 新的訂單
										...
										$SQLStr = "SELECT count(商品代號) as 商品數量 FROM 圖案暫存區 WHERE 帳號='".$_SESSION['ADMINUSER']."'";
										...
										$SQLStr = "INSERT into 訂單明細  SELECT  ".$orderno." as 訂單編號,商品代號,單價,'1' as 優惠方式,'收到訂單' as 處理狀態 FROM 圖案暫存區 WHERE 帳號='".$_SESSION['ADMINUSER']."'";
										...
										$SQLStr = "SELECT 訂單明細.訂單編號,訂單明細.單價,商品.商品名稱,商品照片.圖檔名  FROM 訂單明細 inner join 商品 on  訂單明細.商品代號=商品.商品代號   left outer join 商品照片 on 商品.商品代號=商品照片.商品代號 WHERE 訂單明細.訂單編號='".$orderno."'";
							?>
